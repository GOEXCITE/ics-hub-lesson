function[tauh,kappa,sigma,rbar]=CheckHalfLife(z,iplt,fignum)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% REGRESSION
% z(t)=a+b*z(t-1)+et
%dz=a+(b-1)*z(t-1)+et
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
global ydays;
%[b,bint,r,rint,stats] = regress(z(2:end),[ones(T-1,1) z(1:(end-1))]);
...
%figure(4); qqplot(diff(x),diff(y));title('QQplot of Two stock returns');grid on;
if iplt
 figure(fignum);
